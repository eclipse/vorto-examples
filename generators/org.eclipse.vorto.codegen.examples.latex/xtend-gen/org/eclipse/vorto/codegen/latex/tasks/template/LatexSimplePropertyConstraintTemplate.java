...
public class LatexSimplePropertyConstraintTemplate implements ITemplate<Property> {
  @Override
  public String getContent(final Property property, final InvocationContext invocationContext) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("\\begin{tabular}{|p{4.5cm}|p{4cm}|p{2.05cm}|p{2.05cm}|p{2.05cm}|}");
    _builder.newLine();
    _builder.append("\\hline");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("\\multicolumn{5}{|p{15.5cm}|}{\\textbf{Property}}\\\\");
    _builder.newLine();
    _builder.append("\\hline");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("Name &  Data Type & Min Value & Max Value & Scaling\\\\");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("\\multicolumn{5}{|p{15.5cm}|}{");
    _builder.newLine();
    _builder.append("\t\t");
