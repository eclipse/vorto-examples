...
public class FunctionblockStatusTemplate implements ITemplate<FunctionblockModel> {
  ...
  public FunctionblockStatusTemplate(final String[] imports, final String implSuffix, final String packageName) {
