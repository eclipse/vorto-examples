...
public class AngularGageTemplate implements IFileTemplate<InformationModel> {
  @Override
  public String getFileName(final InformationModel context) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("angular-gage.min.js");
  ...
  public String getPath(final InformationModel context) {
    ...
    _builder.append("-solution/src/main/resources/static/dist/js");
    return _builder.toString();
  }
  ...
  public String getContent(final InformationModel element, final InvocationContext context) {
    ...
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* angular-gage");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* @version v0.1.0 - 2015-06-13");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* @author Francesco Pontillo (francescopontillo@gmail.com)");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* @link https://github.com/frapontillo/angular-gage");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* @license Apache-2.0");
    _builder.newLine();
    _builder.append("**/");
    _builder.newLine();
    _builder.newLine();
