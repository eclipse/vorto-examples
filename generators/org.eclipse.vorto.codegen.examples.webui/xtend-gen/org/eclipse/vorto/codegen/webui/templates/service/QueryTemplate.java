...
public class QueryTemplate implements IFileTemplate<InformationModel> {
  @Override
  public String getFileName(final InformationModel context) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("Query.java");
  ...
  public String getContent(final InformationModel element, final InvocationContext context) {
    ...
    _builder.newLine();
    _builder.append("public interface Query {");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t ");
    _builder.append("* Query Expression");
    _builder.newLine();
    _builder.append("\t ");
    _builder.append("*/");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("String getValue();");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    return _builder.toString();
