...
public class CoAPClientFunctionblockTemplate implements ITemplate<FunctionblockModel> {
  ...
  public CoAPClientFunctionblockTemplate(final String classPackage, final String interfacePrefix, final String implSuffix, final String[] imports, final ITemplate<Property> propertyTemplate, final ITemplate<Operation> operationTemplate) {
  ...
  public String getContent(final FunctionblockModel fbm, final InvocationContext invocationContext) {
    ...
    _builder.newLine();
    _builder.append("import org.eclipse.californium.core.CoapClient;");
    _builder.newLine();
    _builder.append("import org.eclipse.californium.core.CoapResponse;");
    _builder.newLine();
    _builder.append("import org.eclipse.californium.core.CoapObserveRelation;");
    _builder.newLine();
    _builder.append("import org.eclipse.californium.core.CoapHandler;");
    _builder.newLine();
    _builder.newLine();
    {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("String BASE_URI;");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.append(this.implSuffix, "\t");
    _builder.append("(String baseUri){");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.append("BASE_URI = baseUri;");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
